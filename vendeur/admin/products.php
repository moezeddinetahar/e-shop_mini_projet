...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      if($image_size > 2000000){
         ...
         $insert_product = $conn->prepare("INSERT INTO `products`(name, category, price, image, description) VALUES(?,?,?,?,?)");
         $insert_product->execute([$name, $category, $price, $image, $description]);
...
<body>
    ...
    <section class="add-products">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" required placeholder="enter product description" name="description" maxlength="100"
                class="box">
